 ...
 */
final class Version20190305170420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE homework (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, home_task_id INT NOT NULL, git_hub_repository VARCHAR(255) DEFAULT NULL, status INT NOT NULL, INDEX IDX_8C600B4ECB944F1A (student_id), INDEX IDX_8C600B4E3896CADE (home_task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE home_task (id INT AUTO_INCREMENT NOT NULL, topic_id INT NOT NULL, date DATETIME NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_73586AEA1F55203D (topic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, topic_id INT NOT NULL, mentor_id INT NOT NULL, description LONGTEXT NOT NULL, link VARCHAR(255) NOT NULL, INDEX IDX_7CC7DA2C1F55203D (topic_id), INDEX IDX_7CC7DA2CDB403044 (mentor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, text LONGTEXT NOT NULL, chat VARCHAR(255) NOT NULL, INDEX IDX_B6BD307FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE video ADD CONSTRAINT FK_7CC7DA2CDB403044 FOREIGN KEY (mentor_id) REFERENCES user_base_class (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE video DROP FOREIGN KEY FK_7CC7DA2CDB403044');
